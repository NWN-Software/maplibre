...
{
    public static string $name = 'maplibre';

    public static string $viewNamespace = 'maplibre';
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('nwn-software/maplibre');
            });
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/maplibre/{$file->getFilename()}"),
                ], 'maplibre-stubs');
            }
        }
